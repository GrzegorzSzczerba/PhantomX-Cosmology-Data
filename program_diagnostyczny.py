...
if __name__ == "__main__":
    ...
    try:
        ...
        plt.title('Zgodnosc MCMC (Tension-Free Check) dla Modelu 6W-ANRA', fontsize=14, fontweight='bold')
        ...
        plt.savefig('MCMC_Tension_Plot.png', dpi=300)
        print("\n-> ZAPISANO WYKRES DO PLIKU: MCMC_Tension_Plot.png")
